   ...
   public class SalaryRepository : ISalaryRepository
    {
        ...
        public async Task<List<ISalaryModel>> GetFromDatabaseAsync()
        {
            ...
            if (read.HasRows)
            {
                List<ISalaryModel> list2 = new List<ISalaryModel>();
        ...
        public async Task<List<ISalaryModel>> GetWithIDAsync(int id)
        {
        ...
        public async Task<ISalaryModel> PutSalaryAsync(ISalaryModel sal)
        {
            SqlConnection connection = new SqlConnection(connectionString);
        ...
        public async Task<ISalaryModel> UpdateAsync(int id, ISalaryModel sal)
        {
        ...
        public async Task<ISalaryModel> DeleteAsync(int id)
        {
            //string connectionString = "Data Source=DESKTOP-9Q8TC1B;Initial Catalog=people;Integrated Security=True";
            SqlConnection connection = new SqlConnection(connectionString);
