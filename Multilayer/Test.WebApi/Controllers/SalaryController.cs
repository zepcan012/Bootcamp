...
namespace Test.WebApi.Controllers
{
    public class SalaryController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> GetAsync()
        {
            ...
            list = await service.GetSalaryAsync();
        ...
        public async Task<HttpResponseMessage> GetAsync(int id)
        {
            ...
            list = await service.GetSalaryByIDAsync(id);
        ...
        public async Task<HttpResponseMessage> PostAsync(Salary sal)
        {
            ...
            newSal = await service.InsertSalaryAsync(sal);
        ...
        public async Task<HttpResponseMessage> PutAsync(int id, Salary sal)
        {
            ...
            newSal = await service.UpdateSalaryAsync(id, sal);
        ...
        public async Task<HttpResponseMessage> DeleteAsync(int id)
        {
            ...
            newSal = await service.DeleteSalaryAsync(id);
